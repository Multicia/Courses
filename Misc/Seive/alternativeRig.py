...
def multipleRun():
   ...
   r = 10
   for klass in [POM3]:#DTLZ1,DTLZ2,DTLZ3,DTLZ4,DTLZ5,DTLZ6,DTLZ7]:
     ...
     for searcher in [Seive2,Seive2MG,Seive5,MOEAD,DE,Seive4,Seive3,Seive2,Seive,DE]:#PSO,GA,DE,SA,MaxWalkSat]:#Seive2,Seive3,Seive,DE]:
