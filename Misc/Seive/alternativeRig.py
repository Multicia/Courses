...
def multipleRun():
   ...
   for klass in [DTLZ1,DTLZ5,DTLZ6,DTLZ7]:
     ...
     for searcher in [Seive2_V50_1,Seive3,Seive2_V50_2,DE,Seive2]:#,Seive3,Seive2,DE]:#_I1,Seive3]:#Seive2_V50,Seive3,Seive2,Seive4]:#,Seive3,Seive2,Seive4]:#,DE]:#6,Seive25,Seive24,Seive2,DE,Seive4]:#,MOEAD,DE]:
       n = 0.0
       listTimeTaken = []
       listScores = []
       list_eval = []
